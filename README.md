...
| [`connect-ai-hubspot`](skills/connectors/connect-ai-hubspot/SKILL.md) | CRM | HubSpot's three schema surfaces (HubSpotV3, HubSpotV4, and legacy), surface identification via `getSchemas`, per-surface data models, stored procedures, write operations, and HubSpot-specific conventions. |
...
| [`connect-ai-jira`](skills/connectors/connect-ai-jira/SKILL.md) | Collaboration | Jira data model, issue hierarchy, query patterns, stored procedures, and Jira-specific conventions. |
